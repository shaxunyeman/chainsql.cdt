/**
 *  @file
 *  @copyright defined in chainsql.cdt/LICENSE.txt
 */
...
#include "datastream.h" // chainsql::datastream
#include "varint.h"     // chainsql::unsigned_int
...
namespace chainsql {
   ...
   public:
      ...
      char& at(const size_t n) {
         chainsql::check(0 <= n && n < _size, "chainsql::string::at");
         return operator[](n);
      }

      const char at(const size_t n) const {
         chainsql::check(0 <= n && n < _size, "chainsql::string::at const");
         return operator[](n);
      }
      ...
      size_t copy(char* s, size_t len, size_t pos = 0) const {
         chainsql::check(pos <= _size, "chainsql::string::copy");
      ...
      string& insert(const size_t pos, const char* str, const size_t len) {
         chainsql::check((str != nullptr) && (0 <= pos && pos <= _size), "chainsql::string::insert");
      ...
      string& erase(size_t pos = 0, size_t len = npos) {
         chainsql::check(0 <= pos && pos <= _size, "chainsql::string::erase");
      ...
      string& append(const char* str) {
         chainsql::check(str != nullptr, "chainsql::string::append");
         insert(_size, str);
