...
CONTRACT multi_index_example : public contract {
   public:
      ...
      typedef chainsql::multi_index<"testtaba"_n, test_table, chainsql::indexed_by<"secid"_n, chainsql::const_mem_fun<test_table, uint64_t, &test_table::by_secondary>>> test_tables;
