...
```json
{
    "tests": [
        {
            "expected": {
                "stderr": "iostreams currently clash with chainsql::datastream"
            }
        }
    ]
}
...
```json
{
    "tests": [
        {
            "expected": {
                "abi": "{\"____comment\": \"This file was generated with chainsql-abigen. DO NOT EDIT\",\n\"version\": \"chainsql::abi/1.1\",\"types\": [],\"structs\": [..."
            }
        }
    ]
}
