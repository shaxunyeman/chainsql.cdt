...
struct project {
   ...
   const std::string cmake_extern = "include(ExternalProject)\n"
                                    ...
                                    "if(CHAINSQL_CDT_ROOT STREQUAL \"\" OR NOT CHAINSQL_CDT_ROOT)\n"
                                    "   find_package(chainsql.cdt)\n"
                                    "endif()\n\n"
                                    "ExternalProject_Add(\n"
                                    "   @_project\n"
                                    ...
                                    "   CMAKE_ARGS -DCMAKE_TOOLCHAIN_FILE=${CHAINSQL_CDT_ROOT}/lib/cmake/chainsql.cdt/chainsqlWasmToolchain.cmake\n"
                                    "   UPDATE_COMMAND \"\"\n"
                                    "   PATCH_COMMAND \"\"\n"
                                    "   TEST_COMMAND \"\"\n"
                                    "   INSTALL_COMMAND \"\"\n"
   ...
   const std::string readme_bare = " --- @ Project ---\n\n"
                                   " - How to Build -\n"
                                   "   - run the command 'chainsql-cpp -abigen -o @.wasm @.cpp'\n";
